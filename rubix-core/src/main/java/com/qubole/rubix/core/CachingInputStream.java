...
public class CachingInputStream extends FSInputStream
{
  ...
  {
    log.info(String.format("Got Read for file %s, currentPos: %d currentBlock: %d bufferOffset: %d length: %d", remotePath, nextReadPosition, nextReadBlock, offset, length));
